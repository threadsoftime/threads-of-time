...
void ScriptMgr::OnPlayerBuildItemQueryResponse(Player* player, ItemTemplate const* proto, uint32& itemSet)
{
    CALL_ENABLED_HOOKS(PlayerScript, PLAYERHOOK_ON_BUILD_ITEM_QUERY_RESPONSE, script->OnPlayerBuildItemQueryResponse(player, proto, itemSet));
}
