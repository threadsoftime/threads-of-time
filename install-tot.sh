...
# 4c. Seed harness tokens.yaml with the generated bearer token.
...
#     The AC bridge URL is the pod-internal harness-bridge endpoint;
#     adjust if your harness-bridge listens elsewhere.
...
ac_bridge_url: "http://127.0.0.1:8080"
